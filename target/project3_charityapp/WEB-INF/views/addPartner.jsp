				...
				<form action="" method="post">
					...
					<div class="form-group row">
						<spring:bind path="partner.funding">
							<label style="color: white" for="funding">Montant du
								financement :</label>
							<div class="col">
								<input class="col" id="funding" type="text"
									name="${status.expression}" value="${status.value}">
							</div>
							<br />
						</spring:bind>
					...
					<div id="part" style="color: white">

						<h3 class="mb-3 text-center" style="color: white">Détail de
							l' entreprise ou de l'association représentée :</h3>
						<div class="form-group row">
							<spring:bind path="partnerEntity.entityName">

								<label style="color: white" for="entityName">Nom de
									l'entitée représentée :</label>
								<div class="col">
									<input class="col" id="entityName" type="text"
										name="${status.expression}" value="${status.value}">
								</div>
						...
						<div class="form-group row">
							<spring:bind path="partnerEntity.entityregistrationNumber">
								...
								<label style="color: white" for="entityregistrationNumber">Numéro
									d'enregistrement :</label>
								<div class="col">
									<input class="col" id="entityregistrationNumber" type="text"
										name="${status.expression}" value="${status.value}">
								</div>
...
<!-- 	$("#b1").click(hide1); // }); // function hide1(){ // $("p").toggle(); -->
