...
public class AssociationController {
	...
	private String message = "Bonjour" + "Ce mail vous confirme votre inscription !!!!";
	...
	public AssociationController(AssociationService associationService, MailService mailService,
			UserService userService, DonationService donationService, EventService eventService, PromoterService promoterService) {
	...
	public ModelAndView saveNewAssociation(HttpServletRequest request, @ModelAttribute Association association,
...
//    }
	...
	@ResponseBody
	public String checkAssociationAlreadyExist(HttpServletRequest request, @RequestParam("email") String email,
			@RequestParam("rna") int rna) throws NotFoundException {
		...
		if (isRnaOK && isEmailOk)
			return "success";
		else
			return "Les informations fournies ne nous permettent pas de créer de compte, veuillez vérifier votre numéro RNA, ou veuillez choisir un autre email.";
